...
**Size:** a 600x700px (WxH) image and run through an optimization software, like [ImageOptim](https://imageoptim.com/mozjpeg) or [squoosh](https://squoosh.app/). Videos should be 600x400.
